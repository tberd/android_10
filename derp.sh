...
export DERP_BUILD_ZIP_TYPE=VANILLA

rm -rf vendor/gapps

# revert latinemi shit
git -C packages/inputmethods/LatinIME && git -C packages/inputmethods/LatinIME revert 973bbe103901192197b9ca2ac9f03e02e80ccc7d
